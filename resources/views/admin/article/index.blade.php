                  ...
                  <div class="post" style="margin:5px;">
                    <div class="user-block">
                      ...
                      <span class="description">Ditulis oleh <b>{{$item->user->name}}</b> pada {{$item->created_at}}
                        ...
                        <span style="float:right;">Terakhir diedit oleh <b>{{$item->updateLog[0]->user->name}}</b> pada {{$item->updateLog[0]->user->name}}</b> pada {{$item->updateLog[0]->user->created_at}}</span>
                        @endif
                      </span>
                    </div>
                    <!-- /.user-block -->
