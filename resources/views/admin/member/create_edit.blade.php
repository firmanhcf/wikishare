                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="admin">
                            <option value="0" {{($user->admin == 0) ? 'selected':''}}>Staff</option>
                            <option value="3" {{($user->admin == 3) ? 'selected':''}}>Asisten Manajer</option>
                            <option value="2" {{($user->admin == 2) ? 'selected':''}}>Manajer</option>
                          </select>
                        </div>
                    </div>
                  </div>
